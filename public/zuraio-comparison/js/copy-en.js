...
export const pages = {
  ...
  contact: {
    ...
    form: {
      ...
      internalReviewNotice: 'Development notice: form backend visible in internal review mode.',
    },
    formUi: {
      sectionMarker: 'Enquiry form',
      sectionHeading: 'Tell us about your company.',
      labels: {
        name: 'Name',
        company: 'Company',
        role: 'Role',
      ...
      placeholders: { companySize: 'e.g. 50–100 employees' },
      interestEmpty: 'Select an option',
      interestOptions: [
        { value: 'meeting-preparation', label: 'Meeting preparation' },
        { value: 'email-followup', label: 'Email and follow-up' },
        { value: 'knowledge-search', label: 'Internal knowledge search' },
        { value: 'reports-summaries', label: 'Reports and summaries' },
        { value: 'data-control', label: 'Data control' },
        { value: 'technical-architecture', label: 'Technical architecture' },
        { value: 'starter-partner', label: 'Starter partner discussion' },
      ],
      trust: 'Your enquiry will be handled confidentially.',
      submit: 'Send enquiry',
      noscript: 'Send your enquiry to',
      sidebar: {
        marker: 'Three ways to reach us',
        heading: 'Contact paths.',
        demoTitle: '1. Book a demo',
        demoBody: 'Use the form to request a private demo. We typically respond within a few business days.',
        emailTitle: '2. Email directly',
        emailBody: 'For direct enquiries, email us at',
        partnerTitle: '3. Starter partner conversation',
        partnerBody:
          'Interested in shaping Zuraio as an early partner? Mention "starter partner" in your message or use the form interest option.',
        location: 'Switzerland',
      },
      partnerships: {
        marker: 'Partnerships',
        heading: 'Starter partner programme.',
        lede: 'Zuraio works with selected starter partners to deploy practical AI workflows, test real use cases and shape the product roadmap.',
        ...
        whoItems: [
          ...
          'Organisations that want practical first use cases',
        ],
        expectTitle: 'What partners can expect',
        expectItems: [
          'Direct input into product development',
          'Early access to Zuraio AI Hub',
          'Practical workflow selection and controlled pilot setup',
          'Roadmap influence — commercial terms to be agreed',
        ],
