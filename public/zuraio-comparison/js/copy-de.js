...
export const pages = {
  ...
  contact: {
    ...
    form: {
      ...
      internalReviewNotice: 'Entwicklungshinweis: Formular-Backend ist im Internal-Review-Modus sichtbar.',
    },
    formUi: {
      sectionMarker: 'Anfrageformular',
      sectionHeading: 'Erzählen Sie uns von Ihrem Unternehmen.',
      labels: {
        name: 'Name',
        company: 'Unternehmen',
        role: 'Funktion',
      ...
      placeholders: { companySize: 'z. B. 50–100 Mitarbeitende' },
      interestEmpty: 'Option wählen',
      interestOptions: [
        { value: 'meeting-preparation', label: 'Meeting-Vorbereitung' },
        { value: 'email-followup', label: 'E-Mail und Follow-up' },
        { value: 'knowledge-search', label: 'Interne Wissenssuche' },
        { value: 'reports-summaries', label: 'Berichte und Zusammenfassungen' },
        { value: 'data-control', label: 'Datenkontrolle' },
        { value: 'technical-architecture', label: 'Technische Architektur' },
        { value: 'starter-partner', label: 'Starter-Partner-Gespräch' },
      ],
      trust: 'Ihre Anfrage wird vertraulich behandelt.',
      submit: 'Anfrage senden',
      noscript: 'Senden Sie Ihre Anfrage an',
      sidebar: {
        marker: 'Drei Wege zu uns',
        heading: 'Kontaktwege.',
        demoTitle: '1. Demo buchen',
        demoBody: 'Nutzen Sie das Formular für eine private Demo. In der Regel antworten wir innerhalb weniger Werktage.',
        emailTitle: '2. Direkt per E-Mail',
        emailBody: 'Für direkte Anfragen schreiben Sie uns an',
        partnerTitle: '3. Starter-Partner-Gespräch',
        partnerBody:
          'Möchten Sie Zuraio als früher Partner mitgestalten? Erwähnen Sie «Starter-Partner» in Ihrer Nachricht oder wählen Sie die entsprechende Option im Formular.',
        location: 'Schweiz',
      },
      partnerships: {
        marker: 'Partnerschaften',
        heading: 'Starter-Partner-Programm.',
        lede: 'Zuraio arbeitet mit ausgewählten Starter-Partnern zusammen, um praktische KI-Workflows einzuführen, echte Anwendungsfälle zu testen und die Produktroadmap mitzugestalten.',
        whoTitle: 'Für wen',
        whoItems: [
          ...
          'Organisationen mit praktischen ersten Anwendungsfällen',
        ],
        expectTitle: 'Was Partner erwarten können',
        expectItems: [
          'Direkter Einfluss auf die Produktentwicklung',
          'Früher Zugang zum Zuraio AI Hub',
          'Auswahl praktischer Workflows und kontrollierter Pilot',
          'Einfluss auf die Roadmap — kommerzielle Bedingungen werden vereinbart',
        ],
