...
export const SCATTERED_PATHS = [
  /* Mini loops — spread across quadrants and corridors */
  { d: 'M 27 26 C 29 25, 31 27, 29 29 C 27 28, 25 27, 27 26', stroke: '#b5c07a', width: 0.54, opacity: 0.36, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 26 28 C 28 26, 30 28, 28 30 C 26 29, 24 28, 26 28', stroke: '#c2cda8', width: 0.52, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 67 18 C 69 17, 71 19, 69 21 C 67 20, 65 19, 67 18', stroke: '#a8b86e', width: 0.53, opacity: 0.35, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 66 20 C 68 18, 70 20, 68 22 C 66 21, 64 20, 66 20', stroke: '#d0d8bc', width: 0.52, opacity: 0.33, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 29 68 C 31 67, 33 69, 31 71 C 29 70, 27 69, 29 68', stroke: '#b5c07a', width: 0.54, opacity: 0.36, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 28 70 C 30 68, 32 70, 30 72 C 28 71, 26 70, 28 70', stroke: '#c2cda8', width: 0.52, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 81 72 C 83 71, 85 73, 83 75 C 81 74, 79 73, 81 72', stroke: '#a8b86e', width: 0.53, opacity: 0.35, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 80 74 C 82 72, 84 74, 82 76 C 80 75, 78 74, 80 74', stroke: '#d0d8bc', width: 0.52, opacity: 0.33, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 19 44 C 21 43, 23 45, 21 47 C 19 46, 17 45, 19 44', stroke: '#b5c07a', width: 0.54, opacity: 0.36, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 18 46 C 20 44, 22 46, 20 48 C 18 47, 16 46, 18 46', stroke: '#c2cda8', width: 0.52, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 77 48 C 79 47, 81 49, 79 51 C 77 50, 75 49, 77 48', stroke: '#a8b86e', width: 0.53, opacity: 0.35, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 76 50 C 78 48, 80 50, 78 52 C 76 51, 74 50, 76 50', stroke: '#d0d8bc', width: 0.52, opacity: 0.33, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 49 42 C 51 41, 53 43, 51 45 C 49 44, 47 43, 49 42', stroke: '#b5c07a', width: 0.52, opacity: 0.32, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 48 24 C 50 23, 52 25, 50 27 C 48 26, 46 25, 48 24', stroke: '#c2cda8', width: 0.52, opacity: 0.32, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 47 70 C 49 69, 51 71, 49 73 C 47 72, 45 71, 47 70', stroke: '#a8b86e', width: 0.52, opacity: 0.32, animate: 'static', delay: 0, duration: 0 },
  ...
  { d: 'M 12 38 C 24 40, 38 42, 52 44 C 62 46, 76 44, 88 40', stroke: '#d0d8bc', width: 0.53, opacity: 0.32, animate: 'fade', delay: 0.8, duration: 13 },
  ...
  { d: 'M 26 32 C 34 38, 42 42, 52 44 C 58 46, 66 52, 74 16', stroke: '#b5c07a', width: 0.54, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 34 78 C 40 66, 46 54, 48 48 C 54 34, 60 24, 62 20', stroke: '#c2cda8', width: 0.53, opacity: 0.33, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 56 86 C 52 72, 52 58, 54 46 C 48 30, 46 20, 44 8', stroke: '#a8b86e', width: 0.54, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  ...
  { d: 'M 16 14 C 22 26, 28 38, 34 46 C 42 50, 46 46, 52 44', stroke: '#9aab78', width: 0.55, opacity: 0.36, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 84 12 C 78 24, 70 36, 62 44 C 56 48, 52 46, 58 40', stroke: '#a8b86e', width: 0.54, opacity: 0.35, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 18 62 C 26 56, 36 50, 44 46 C 48 44, 46 52, 42 58', stroke: '#b5c07a', width: 0.53, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 90 54 C 82 50, 72 46, 62 44 C 56 44, 60 52, 66 60', stroke: '#9aab78', width: 0.54, opacity: 0.35, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 26 32 C 32 36, 40 40, 48 42 C 58 48, 66 54, 74 16', stroke: '#a8b86e', width: 0.53, opacity: 0.34, animate: 'fade', delay: 0.45, duration: 13 },
  ...
  { d: 'M 44 8 C 46 20, 48 32, 52 44 C 52 56, 54 68, 56 86', stroke: '#9aab78', width: 0.53, opacity: 0.34, animate: 'fade', delay: 1.65, duration: 15 },
  { d: 'M 88 68 C 78 60, 66 52, 54 46 C 34 36, 22 28, 10 38', stroke: '#a8b86e', width: 0.54, opacity: 0.35, animate: 'fade', delay: 2.25, duration: 14 },
];
