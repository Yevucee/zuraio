...
/**
 * Solid curved paths — each line joins icons at their coordinates.
 * Chains use varied control points for an organic, non-uniform tangle.
 */
export const SCATTERED_PATHS = [
  { d: 'M 16 14 Q 19 24 26 32 Q 31 41 30 46 Q 38 46 50 44', stroke: '#b8c878', width: 0.95, opacity: 0.46, animate: 'draw', delay: 0, duration: 11 },
  { d: 'M 84 12 Q 73 16 62 20 Q 53 14 44 8 Q 30 10 16 14', stroke: '#8ca33f', width: 1.0, opacity: 0.48, animate: 'fade', delay: 0.5, duration: 10 },
  { d: 'M 18 62 Q 34 53 50 44 Q 70 49 90 54', stroke: '#b8c878', width: 0.92, opacity: 0.44, animate: 'draw', delay: 0.9, duration: 12 },
  { d: 'M 8 78 Q 19 79 34 78 Q 28 70 18 62', stroke: '#cfd6c3', width: 0.88, opacity: 0.42, animate: 'fade', delay: 1.3, duration: 9 },
  { d: 'M 10 38 Q 17 35 26 32 Q 22 24 16 14', stroke: '#dce7b7', width: 0.9, opacity: 0.4, animate: 'draw', delay: 0.3, duration: 10 },
  { d: 'M 94 28 Q 89 20 84 12 Q 73 15 62 20', stroke: '#b8c878', width: 0.93, opacity: 0.43, animate: 'fade', delay: 1.7, duration: 11 },
  { d: 'M 56 86 Q 47 82 34 78 Q 33 62 30 46 Q 40 44 50 44', stroke: '#8ca33f', width: 0.96, opacity: 0.45, animate: 'draw', delay: 1.1, duration: 13 },
  { d: 'M 82 76 Q 85 72 88 68 Q 89 61 90 54', stroke: '#cfd6c3', width: 0.87, opacity: 0.41, animate: 'fade', delay: 2.1, duration: 10 },
  { d: 'M 36 92 Q 46 89 56 86 Q 69 81 82 76', stroke: '#b8c878', width: 0.91, opacity: 0.42, animate: 'draw', delay: 0.7, duration: 12 },
  { d: 'M 96 60 Q 93 57 90 54 Q 89 61 88 68', stroke: '#dce7b7', width: 0.89, opacity: 0.4, animate: 'fade', delay: 2.5, duration: 11 },
  { d: 'M 74 16 Q 68 18 62 20 Q 72 16 84 12', stroke: '#b8c878', width: 0.94, opacity: 0.44, animate: 'draw', delay: 1.5, duration: 9 },
  { d: 'M 44 8 Q 47 26 50 44 Q 56 32 62 20', stroke: '#cfd6c3', width: 0.9, opacity: 0.42, animate: 'fade', delay: 0.2, duration: 10 },
  { d: 'M 8 78 Q 6 58 10 38', stroke: '#b8c878', width: 0.86, opacity: 0.4, animate: 'draw', delay: 2.8, duration: 8 },
  { d: 'M 34 78 Q 26 70 18 62', stroke: '#8ca33f', width: 0.92, opacity: 0.43, animate: 'fade', delay: 1.9, duration: 9 },
  { d: 'M 26 32 Q 18 35 10 38', stroke: '#cfd6c3', width: 0.88, opacity: 0.39, animate: 'draw', delay: 2.3, duration: 10 },
  { d: 'M 30 46 Q 24 54 18 62', stroke: '#b8c878', width: 0.9, opacity: 0.41, animate: 'fade', delay: 0.6, duration: 11 },
  { d: 'M 50 44 Q 56 32 62 20', stroke: '#dce7b7', width: 0.93, opacity: 0.42, animate: 'draw', delay: 1.4, duration: 9 },
  { d: 'M 50 44 Q 69 56 88 68', stroke: '#b8c878', width: 0.91, opacity: 0.43, animate: 'fade', delay: 2.0, duration: 12 },
  { d: 'M 94 28 Q 92 41 90 54', stroke: '#cfd6c3', width: 0.87, opacity: 0.4, animate: 'draw', delay: 0.4, duration: 10 },
  { d: 'M 56 86 Q 46 89 36 92', stroke: '#8ca33f', width: 0.9, opacity: 0.42, animate: 'fade', delay: 2.6, duration: 9 },
  { d: 'M 16 14 Q 12 38 18 62', stroke: '#b8c878', width: 0.95, opacity: 0.44, animate: 'draw', delay: 1.0, duration: 11 },
  { d: 'M 84 12 Q 87 33 90 54', stroke: '#cfd6c3', width: 0.89, opacity: 0.41, animate: 'fade', delay: 1.8, duration: 10 },
  { d: 'M 8 78 Q 17 62 30 46', stroke: '#dce7b7', width: 0.88, opacity: 0.39, animate: 'draw', delay: 2.2, duration: 12 },
  { d: 'M 82 76 Q 69 81 56 86', stroke: '#b8c878', width: 0.92, opacity: 0.42, animate: 'fade', delay: 0.8, duration: 9 },
  { d: 'M 10 38 Q 14 50 18 62', stroke: '#8ca33f', width: 0.9, opacity: 0.41, animate: 'draw', delay: 3.0, duration: 10 },
  { d: 'M 34 78 Q 42 61 50 44', stroke: '#cfd6c3', width: 0.93, opacity: 0.43, animate: 'fade', delay: 1.2, duration: 11 },
  { d: 'M 62 20 Q 68 18 74 16', stroke: '#b8c878', width: 0.86, opacity: 0.4, animate: 'draw', delay: 2.4, duration: 8 },
  { d: 'M 88 68 Q 72 77 56 86', stroke: '#dce7b7', width: 0.91, opacity: 0.42, animate: 'fade', delay: 0.1, duration: 10 },
  { d: 'M 16 14 Q 30 10 44 8 Q 53 14 62 20 Q 78 24 94 28', stroke: '#8ca33f', width: 0.97, opacity: 0.45, animate: 'draw', delay: 1.6, duration: 14 },
  { d: 'M 18 62 Q 26 70 34 78 Q 21 78 8 78 Q 9 58 10 38', stroke: '#b8c878', width: 0.94, opacity: 0.44, animate: 'fade', delay: 2.7, duration: 13 },
  { d: 'M 90 54 Q 89 61 88 68 Q 85 72 82 76 Q 69 81 56 86 Q 46 89 36 92', stroke: '#cfd6c3', width: 0.95, opacity: 0.43, animate: 'draw', delay: 0.15, duration: 15 },
  { d: 'M 50 44 Q 38 36 26 32 Q 17 35 10 38', stroke: '#b8c878', width: 0.9, opacity: 0.42, animate: 'fade', delay: 1.45, duration: 12 },
  { d: 'M 50 44 Q 62 36 74 16 Q 68 18 62 20', stroke: '#8ca33f', width: 0.92, opacity: 0.43, animate: 'draw', delay: 2.15, duration: 11 },
];
