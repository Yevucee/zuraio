...
export const SCATTERED_PATHS = [
  ...
  { d: 'M 49 41 C 53 39, 55 43, 51 47 C 47 45, 45 41, 49 41', stroke: '#b5c07a', width: 0.54, opacity: 0.36, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 51 43 C 55 47, 49 49, 47 45 C 49 41, 53 43, 51 43', stroke: '#c2cda8', width: 0.52, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 48 44 C 52 40, 56 44, 52 48 C 48 46, 44 48, 48 44', stroke: '#a8b86e', width: 0.53, opacity: 0.35, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 50 42 C 54 46, 50 50, 46 46 C 48 42, 52 42, 50 42', stroke: '#d0d8bc', width: 0.52, opacity: 0.33, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 47 43 C 51 41, 55 45, 51 49 C 47 47, 43 45, 47 43', stroke: '#b5c07a', width: 0.54, opacity: 0.36, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 52 44 C 48 40, 44 44, 48 48 C 52 46, 56 44, 52 44', stroke: '#c2cda8', width: 0.52, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 50 40 C 46 44, 50 48, 54 44 C 52 40, 48 38, 50 40', stroke: '#a8b86e', width: 0.53, opacity: 0.35, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 49 45 C 53 43, 57 47, 53 51 C 49 49, 45 47, 49 45', stroke: '#d0d8bc', width: 0.52, opacity: 0.33, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 51 41 C 47 45, 51 49, 55 45 C 53 41, 49 39, 51 41', stroke: '#b5c07a', width: 0.54, opacity: 0.36, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 48 42 C 52 46, 48 50, 44 46 C 46 42, 50 40, 48 42', stroke: '#c2cda8', width: 0.52, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 50 44 C 42 38, 58 38, 50 44 C 42 50, 58 50, 50 44', stroke: '#a8b86e', width: 0.53, opacity: 0.35, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 46 44 C 50 40, 54 44, 50 48 C 46 46, 42 44, 46 44', stroke: '#d0d8bc', width: 0.52, opacity: 0.33, animate: 'static', delay: 0, duration: 0 },
  /* Wide sweeps — pass through centre, fade before edges */
  { d: 'M 14 16 C 26 30, 38 40, 50 44 C 62 48, 74 34, 86 18', stroke: '#b5c07a', width: 0.55, opacity: 0.34, animate: 'fade', delay: 0.2, duration: 14 },
  { d: 'M 12 72 C 24 60, 38 50, 50 44 C 62 38, 76 52, 88 74', stroke: '#c2cda8', width: 0.54, opacity: 0.33, animate: 'fade', delay: 0.6, duration: 15 },
  { d: 'M 18 12 C 32 24, 42 36, 50 44 C 58 52, 70 64, 84 78', stroke: '#a8b86e', width: 0.55, opacity: 0.34, animate: 'fade', delay: 1.0, duration: 16 },
  { d: 'M 88 14 C 74 26, 60 38, 50 44 C 40 50, 28 62, 16 78', stroke: '#d0d8bc', width: 0.54, opacity: 0.33, animate: 'fade', delay: 1.4, duration: 15 },
  { d: 'M 86 72 C 72 58, 58 48, 50 44 C 42 40, 28 28, 14 14', stroke: '#b5c07a', width: 0.55, opacity: 0.34, animate: 'fade', delay: 1.8, duration: 14 },
  { d: 'M 16 14 C 28 28, 40 38, 50 44 C 60 50, 72 60, 84 72', stroke: '#c2cda8', width: 0.54, opacity: 0.33, animate: 'fade', delay: 2.2, duration: 16 },
  { d: 'M 84 12 C 70 22, 58 34, 50 44 C 42 54, 30 66, 18 82', stroke: '#a8b86e', width: 0.55, opacity: 0.34, animate: 'fade', delay: 0.4, duration: 15 },
  { d: 'M 12 38 C 24 40, 38 42, 50 44 C 62 46, 76 44, 88 40', stroke: '#d0d8bc', width: 0.53, opacity: 0.32, animate: 'fade', delay: 0.8, duration: 13 },
  { d: 'M 14 52 C 26 50, 38 48, 50 44 C 62 40, 74 36, 86 32', stroke: '#b5c07a', width: 0.54, opacity: 0.33, animate: 'fade', delay: 1.2, duration: 14 },
  { d: 'M 20 20 C 34 32, 44 40, 50 44 C 56 48, 66 58, 78 70', stroke: '#c2cda8', width: 0.55, opacity: 0.34, animate: 'fade', delay: 1.6, duration: 15 },
  { d: 'M 80 20 C 66 32, 56 40, 50 44 C 44 48, 34 58, 22 70', stroke: '#a8b86e', width: 0.54, opacity: 0.33, animate: 'fade', delay: 2.0, duration: 15 },
  { d: 'M 22 82 C 34 68, 44 56, 50 44 C 56 32, 66 22, 78 12', stroke: '#d0d8bc', width: 0.55, opacity: 0.34, animate: 'fade', delay: 2.4, duration: 16 },
  /* S-curves weaving through icon field */
  { d: 'M 16 14 C 24 32, 36 44, 50 44 C 64 44, 76 32, 84 12', stroke: '#b5c07a', width: 0.54, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 18 62 C 28 54, 40 48, 50 44 C 60 40, 72 48, 90 54', stroke: '#c2cda8', width: 0.53, opacity: 0.33, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 8 78 C 18 64, 28 52, 50 44 C 72 36, 82 48, 94 28', stroke: '#a8b86e', width: 0.54, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 10 38 C 20 36, 30 40, 50 44 C 70 48, 80 44, 96 60', stroke: '#d0d8bc', width: 0.53, opacity: 0.32, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 26 32 C 34 38, 42 42, 50 44 C 58 46, 66 52, 74 16', stroke: '#b5c07a', width: 0.54, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 34 78 C 40 66, 46 54, 50 44 C 54 34, 60 24, 62 20', stroke: '#c2cda8', width: 0.53, opacity: 0.33, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 56 86 C 52 72, 52 58, 50 44 C 48 30, 46 20, 44 8', stroke: '#a8b86e', width: 0.54, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 82 76 C 74 64, 64 52, 50 44 C 36 36, 26 48, 18 62', stroke: '#d0d8bc', width: 0.53, opacity: 0.32, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 88 68 C 76 58, 62 50, 50 44 C 38 38, 24 28, 16 14', stroke: '#b5c07a', width: 0.54, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 36 92 C 42 78, 48 62, 50 44 C 52 26, 58 14, 84 12', stroke: '#c2cda8', width: 0.53, opacity: 0.33, animate: 'static', delay: 0, duration: 0 },
  ...
  { d: 'M 15 16 C 30 20, 42 32, 50 44 C 58 56, 68 68, 82 76', stroke: '#a8b86e', width: 0.54, opacity: 0.33, animate: 'fade', delay: 0.9, duration: 17 },
  { d: 'M 85 16 C 70 22, 58 34, 50 44 C 42 54, 32 66, 18 76', stroke: '#d0d8bc', width: 0.54, opacity: 0.33, animate: 'fade', delay: 1.3, duration: 17 },
  { d: 'M 16 14 C 32 18, 44 30, 50 44 C 56 58, 64 72, 72 84', stroke: '#b5c07a', width: 0.55, opacity: 0.34, animate: 'fade', delay: 1.7, duration: 18 },
  { d: 'M 84 12 C 68 18, 56 30, 50 44 C 44 58, 36 72, 28 84', stroke: '#c2cda8', width: 0.54, opacity: 0.33, animate: 'fade', delay: 2.1, duration: 18 },
  { d: 'M 10 40 C 22 38, 36 40, 50 44 C 64 48, 78 52, 90 58', stroke: '#a8b86e', width: 0.53, opacity: 0.32, animate: 'fade', delay: 2.5, duration: 14 },
  { d: 'M 10 50 C 22 48, 36 46, 50 44 C 64 42, 78 40, 90 36', stroke: '#d0d8bc', width: 0.53, opacity: 0.32, animate: 'fade', delay: 0.1, duration: 14 },
  { d: 'M 20 12 C 34 24, 44 36, 50 44 C 56 52, 64 64, 74 74', stroke: '#b5c07a', width: 0.54, opacity: 0.33, animate: 'fade', delay: 0.15, duration: 16 },
  { d: 'M 80 12 C 66 24, 56 36, 50 44 C 44 52, 36 64, 26 74', stroke: '#c2cda8', width: 0.54, opacity: 0.33, animate: 'fade', delay: 2.9, duration: 16 },
  /* Extra flowing arcs — smoother sweeps through the field */
  { d: 'M 16 14 C 22 26, 28 38, 34 46 C 42 50, 46 46, 50 44', stroke: '#9aab78', width: 0.55, opacity: 0.36, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 84 12 C 78 24, 70 36, 62 44 C 56 48, 52 46, 50 44', stroke: '#a8b86e', width: 0.54, opacity: 0.35, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 18 62 C 26 56, 36 50, 44 46 C 48 44, 50 44, 50 44', stroke: '#b5c07a', width: 0.53, opacity: 0.34, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 90 54 C 82 50, 72 46, 62 44 C 56 44, 52 44, 50 44', stroke: '#9aab78', width: 0.54, opacity: 0.35, animate: 'static', delay: 0, duration: 0 },
  { d: 'M 26 32 C 32 36, 40 40, 50 44 C 58 48, 66 54, 74 16', stroke: '#a8b86e', width: 0.53, opacity: 0.34, animate: 'fade', delay: 0.45, duration: 13 },
  { d: 'M 62 20 C 58 28, 54 36, 50 44 C 46 52, 40 60, 34 78', stroke: '#b5c07a', width: 0.54, opacity: 0.35, animate: 'fade', delay: 1.05, duration: 14 },
  { d: 'M 44 8 C 46 20, 48 32, 50 44 C 52 56, 54 68, 56 86', stroke: '#9aab78', width: 0.53, opacity: 0.34, animate: 'fade', delay: 1.65, duration: 15 },
  { d: 'M 88 68 C 78 60, 66 52, 50 44 C 34 36, 22 28, 10 38', stroke: '#a8b86e', width: 0.54, opacity: 0.35, animate: 'fade', delay: 2.25, duration: 14 },
];
