...
export const SCATTERED_FRAGMENTS = [
  { id: 'document', type: 'document', x: 16, y: 14, drift: 6.2, delay: 0.1, pulse: 6.2, flash: true },
  { id: 'email', type: 'email', x: 84, y: 12, drift: 6.8, delay: 0.6, pulse: 7.4, flash: true },
  { id: 'folder', type: 'folder', x: 18, y: 62, drift: 5.8, delay: 1.1, pulse: 5.8 },
  { id: 'database', type: 'database', x: 90, y: 54, drift: 7.0, delay: 0.4, pulse: 6.6, flash: true },
  { id: 'calendar', type: 'calendar', x: 44, y: 8, drift: 6.4, delay: 1.8, pulse: 7.8, secondary: true },
  { id: 'cloud', type: 'cloud', x: 94, y: 28, drift: 5.8, delay: 0.9, pulse: 6.0 },
  { id: 'chat', type: 'chat', x: 8, y: 78, drift: 7.0, delay: 1.4, pulse: 5.4, flash: true },
  { id: 'magnifier', type: 'magnifier', x: 50, y: 44, drift: 5.5, delay: 0.3, pulse: 8.2, hub: true },
  { id: 'browser', type: 'browser', x: 26, y: 32, drift: 6.1, delay: 2.0, pulse: 7.1, secondary: true },
  { id: 'spreadsheet', type: 'spreadsheet', x: 82, y: 76, drift: 5.6, delay: 1.6, pulse: 6.9, secondary: true },
  { id: 'video', type: 'video', x: 56, y: 86, drift: 7.2, delay: 0.7, pulse: 5.9 },
  { id: 'grid', type: 'grid', x: 34, y: 78, drift: 6.3, delay: 1.2, pulse: 7.0 },
  { id: 'brain-upper', type: 'brain', x: 62, y: 20, drift: 5.0, delay: 0.8, brainPulse: 5.2 },
  { id: 'brain-mid', type: 'brain', x: 30, y: 46, drift: 4.8, delay: 1.5, brainPulse: 6.4 },
  { id: 'brain-lower', type: 'brain', x: 88, y: 68, drift: 5.8, delay: 2.1, brainPulse: 4.8 },
  { id: 'clock-left', type: 'clock', x: 10, y: 38, drift: 6.2, delay: 0.4, clockAnim: 28 },
  { id: 'clock-lower', type: 'clock', x: 36, y: 92, drift: 5.4, delay: 1.3, clockAnim: 32 },
  { id: 'clock-right', type: 'clock', x: 96, y: 60, drift: 6.6, delay: 0.9, clockAnim: 26 },
  { id: 'clock-upper', type: 'clock', x: 74, y: 16, drift: 5.9, delay: 1.7, clockAnim: 30, secondary: true },
];
